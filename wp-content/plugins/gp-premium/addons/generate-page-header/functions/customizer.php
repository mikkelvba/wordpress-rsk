...
function generate_page_header_blog_customizer( $wp_customize ) {
	...
	$wp_customize->add_panel( 'generate_blog_page_header_panel', array(
		...
		'theme_supports' => '',
		'title'          => __( 'Blog Page Header','generate' ),
		'description'    => '',
	) );
	...
	$wp_customize->add_section(
		...
		// Arguments array
		array(
			'title' => __( 'Image Settings', 'generate-page-header' ),
			'capability' => 'edit_theme_options',
			'panel' => 'generate_blog_page_header_panel'
		)
	);
	...
	$wp_customize->add_setting( 
		...
		array(
			...
			'type' => 'option',
			'sanitize_callback' => 'generate_page_header_sanitize_integer'
		)
	);
	...
	$wp_customize->add_section(
		...
		// Arguments array
		array(
			'title' => __( 'Video Settings', 'generate-page-header' ),
			'capability' => 'edit_theme_options',
			'panel' => 'generate_blog_page_header_panel'
		)
	);
	...
	$wp_customize->add_section(
		...
		// Arguments array
		array(
			'title' => __( 'Content Settings', 'generate-page-header' ),
			'capability' => 'edit_theme_options',
			'panel' => 'generate_blog_page_header_panel'
		)
	);
	...
	$wp_customize->add_section(
		...
		// Arguments array
		array(
			'title' => __( 'Advanced Settings', 'generate-page-header' ),
			'capability' => 'edit_theme_options',
			'panel' => 'generate_blog_page_header_panel'
		)
	);
	...
	$wp_customize->add_section(
		...
		// Arguments array
		array(
			'title' => __( 'Logo', 'generate-page-header' ),
			'capability' => 'edit_theme_options',
			'panel' => 'generate_blog_page_header_panel'
		)
	);
