			...
			<?php else : ?>
				...
				if( '' !== $sections ) :
					...
					foreach ( $sections['sections'] as $section ) :
						...
						if ( 'contained' == $inner_box_type ) :
							$inner_container['before'] = '<div class="grid-container grid-parent generate-sections-inside-container">';
							$inner_container['after'] = '</div>';
						elseif ( 'fluid' == $inner_box_type ) :
							$inner_container['before'] = '<div class="generate-sections-inside-container">';
							$inner_container['after'] = '</div>';
						endif;
						
						// Output the container
						echo $container['before'];
						echo $inner_container['before'];
