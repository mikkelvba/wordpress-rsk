		...
		<div class="group-inside">
			...
			<div class="customEditor wp-core-ui wp-editor-wrap <?php echo 'tmce-active'; //echo $switch_class;?>">
				...
				<div class="wp-editor-container">
					<textarea style="height:300px;" class="wp-sections-area tmce-enabled" name="<?php $mb->the_name(); ?>"><?php remove_filter( 'generate_section_content', 'do_shortcode'); echo esc_html( apply_filters( 'generate_section_content', html_entity_decode( $mb->get_the_value(), ENT_COMPAT, 'UTF-8' ) ) ); add_filter( 'generate_section_content', 'do_shortcode'); ?></textarea>
				</div>
