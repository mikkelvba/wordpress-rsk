...
class Wp_Scss_Settings
{
    ...
    public function create_admin_page()
    {
        ...
        <div class="wrap">
            <?php screen_icon(); ?>
            <h2>Scss Compiler Settings</h2>   
            <p>
              <span class="version">Version 2.0.<em><?php echo get_option('wpscss_version'); ?></em>
              <br/>
              <span class="author">By: <a href="http://mikkelva.dk" target="_blank">Mikkel Veldt Andersen</a></span>
            </p>        
    ...
    public function print_enqueue_info() {
        print 'Scss Compiler can enqueue your css stylesheets in the header automatically.';
    }
